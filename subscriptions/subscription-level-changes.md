...
| -------- | ------------------- | ------------- |
| **Upgrade** | Usually | Install the higher IDE version, then review new benefits |
...
The changes very by benefit type. This article provides examples and explains the effects of upgrades and downgrades for key benefits.
...
You keep perpetual use rights for the version included at the higher level. You might not be able to sign in to keep using that higher edition after your access changes. To avoid disruption, confirm you can still validate the IDE license before your subscription level changes. This validation can be done by signing in with an eligible account or by using a product key from the [product keys page](https://my.visualstudio.com/productkeys). Learn more about [finding and claiming product keys](find-keys.md).

### What happens to your individual Azure credits?
...
### Avoid losing your Azure assets
