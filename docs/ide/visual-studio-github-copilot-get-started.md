...
1. In the Chat window, enter a prompt to start using Copilot.
   ...
   :::moniker range="vs-2022"
      ...
      :::image type="content" source="media/ide/vs-2022/visual-studio-github-copilot-chat/get-started-with-copilot-free-dialog.png" alt-text="Screenshot showing the Get Started with Copilot Free dialog in Visual Studio.":::
